...
export default function Hero3D({ locale, onCtaClick }: Hero3DProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hero-3d__background" style={{
        position: 'absolute',
        top: 0,
        left: 0,
        right: 0,
        ...
        {prefersReducedMotion && (
          <div 
            ...
            style={{
              width: '100%',
              height: '100%',
              background: 'radial-gradient(ellipse at center, rgba(255, 215, 0, 0.1) 0%, rgba(255, 215, 0, 0.05) 50%, transparent 100%)',
            }}
          />
        )}
      </div>
      ...
      {/* Content Overlay */}
      <div className="hero-3d__content" style={{
        position: 'relative',
        zIndex: 2,
        width: '100%',
        maxWidth: '1200px',
        ...
        <div className="hero-3d__container" style={{
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          gap: '3rem',
        }}>
          <header className="hero-3d__header" style={{
            display: 'flex',
            flexDirection: 'column',
            gap: '1.5rem',
          }}>
            ...
            <p className="hero-3d__subheadline" style={{
          ...
          <div className="hero-3d__benefits" style={{
            width: '100%',
            maxWidth: '600px',
          }}>
            <ul 
            ...
            >
              {content.bullets.map((bullet, index) => (
                ...
                >
                  <span className="hero-3d__bullet-icon" aria-hidden="true" style={{
                    color: '#FFD700',
                    fontWeight: 'bold',
                    flexShrink: 0,
                    marginTop: '0.1rem',
          ...
          <div className="hero-3d__actions" style={{
            display: 'flex',
            justifyContent: 'center',
          }}>
            <button
